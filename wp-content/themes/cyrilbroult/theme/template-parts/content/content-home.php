<section id="home-slider">
    ...
    <a href="#home-reassurances" class="scroll-arrow"><img
            src="<?php echo get_template_directory_uri(); ?>/src/img/arrow-down-white.svg" alt="white arrow down"
        ...
        <div class="swiper-wrapper">
            ...
            <div id="<?php echo $key; ?>" class="reassurance swiper-slide">
                ...
                <img src="<?php echo $reassurance["icon_$i"]['url']; ?>"
                    alt="<?php echo $reassurance["icon_$i"]['name']; ?>" width="80" height="80" loading="lazy">
